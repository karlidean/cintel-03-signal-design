"""
signal_design_karlidean.py - Project script
...
Paths (relative to repo root)
    ...
    OUTPUT FILE: artifacts/signals_karlidean.csv

Terminal command to run this file from the root project folder

    uv run python -m cintel.signal_design_karlidean
...
def main() -> None:
    ...
    # ----------------------------------------------------
    # STEP 2.6: DEFINE THE LATENCY ALERT SIGNAL RECIPE
    # ----------------------------------------------------
    # If avg latency > 30, flag as 1, else 0
    latency_alert_signal_recipe: pl.Expr = (
        pl.when(calculated_avg_latency >= 30)
        .then(1)
        .otherwise(0)
        .alias("latency_alert")
    )
    ...
    # ----------------------------------------------------
    # STEP 2.7: DEFINE THE THROUGHPUT SIGNAL RECIPE
    # ----------------------------------------------------
